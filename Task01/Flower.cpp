...
Flower::Flower(sf::RenderWindow* win) : window(win) {
    ...
    petal5.setRadius(15.f); petal5.setFillColor(diagPetalColor); petal5.setPosition({ 68.f, 108.f });
    petal6 = petal5; petal6.setPosition({ 112.f, 108.f });
    petal7 = petal5; petal7.setPosition({ 68.f, 152.f });
    petal8 = petal5; petal8.setPosition({ 112.f, 152.f });
...
void Flower::draw() {
    ...
    //  Cloud movement
    cloudOffsetX -= 0.015f;
    if (130.f + cloudOffsetX + (60.f * 1.5f) < 0.f) cloudOffsetX = 100.f;
